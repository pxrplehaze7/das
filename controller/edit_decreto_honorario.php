...
if (isset($_POST['iddecreto'])) {
  ...
  if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM honorario WHERE Rut = '$rutPersona'")) > 0) {
    ...
    $sqld = "SELECT * FROM decretosh WHERE IDdecretoH = '$iddecreto'";
  ...
  if (
    ...
    $sqlDecretos = "UPDATE decretosh SET
    TipodeHono = '$tipohonorario',
    IDLugar = $lugar,
    IDSector = $sector,
    NDecreto = $numdecreto,
    ...
    $sqlcumple = "UPDATE honorario SET Cumple = $cumple WHERE IDTraH =$idtraH";
