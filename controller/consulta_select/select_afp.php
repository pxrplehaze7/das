<?php
 ...
 echo "<select name='nameSelectAFP' id='idSelectAFP' class='form-select'> require";
 echo '<option value="" hidden"> Selecciona una AFP</option>'; // Opción por defecto en blanco
