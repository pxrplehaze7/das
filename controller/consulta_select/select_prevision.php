...
echo "<select name='nameSelectPrev' id='idSelectPrev' class='form-select' require>";
echo '<option hidden value=""> Selecciona una Previsión</option>'; // Opción por defecto en blanco
