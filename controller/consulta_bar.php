...
if ($das_t != 0) {
    $porcentajedas = (($das_t - $das_c) / $das_t) * 100;
} else {
    $porcentajedas = 0; 
}
...
if ($pin_t != 0) {
    $porcentajepin = (($pin_t - $pin_c) / $pin_t) * 100;
} else {
    $porcentajepin = 0; 
}
...
if ($pin_t != 0) {
    $porcentajeleo = (($leo_t - $leo_c) / $leo_t) * 100;
} else {
    $porcentajeleo = 0; 
}
...
if ($valle_t != 0) {
    $porcentajevalle = (($valle_t - $valle_c) / $valle_t) * 100;
} else {
    $porcentajevalle = 0; 
}
...
if ($chigua_t != 0) {
    $porcentajechi = (($chigua_t - $chigua_c) / $chigua_t) * 100;
} else {
    $porcentajechi = 0; 
}
