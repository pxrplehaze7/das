...
$CheckRut = "SELECT Rut FROM trabajador WHERE Rut = '$rutPersona'";
$resultadoCheck = mysqli_query($conn, $CheckRut);
if (mysqli_num_rows($resultadoCheck) > 0) {
    // Si el rut ya existe en la base de datos, mostrar un mensaje de error
