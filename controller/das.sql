...
CREATE TABLE `das`.`trabajador` (
    ...
    `RutaPrev` VARCHAR(400) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
    `RutaCV` VARCHAR(400) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
    ...
    `RutaAntec` VARCHAR(400) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
    `RutaCedula` VARCHAR(400) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
    `RutaEstudio` VARCHAR(400) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
    `RutaDJur` VARCHAR(400) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
    `RutaSerM` VARCHAR(400) CHARACTER SET utf8 COLLATE utf8_spanish_ci NULL,
    `RutaSCom` VARCHAR(400) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
