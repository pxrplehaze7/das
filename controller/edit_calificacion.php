...
if (mysqli_num_rows(mysqli_query($conn, "SELECT * FROM calificaciones WHERE IDCalif = '$idCalificacion'")) > 0) {
    ...
    if (isset($_FILES['nameCalifdoc']) && isset($_FILES['nameCalifdoc']['tmp_name'])) {
    ...
    if (isset($_FILES['nameApelacionDoc']) && isset($_FILES['nameApelacionDoc']['tmp_name'])) {
