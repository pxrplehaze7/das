...
if (!empty($persona['RutaContrato'])) { ?>
    <div class="contenedor-botones">
        ...
        <button type="button" class="btn btn-danger w-100 boton-eliminar" onclick="event.preventDefault(); deleteFile('RutaContrato', '<?php echo $persona['IDTra']; ?>')"><i class="fa-solid fa-trash"></i></button>
