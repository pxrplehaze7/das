...
if (!empty($persona['RutaSerM'])) { ?>
    <div class="contenedor-botones">
        ...
        <button type="button" class="btn btn-danger w-100 boton-eliminar" onclick="event.preventDefault(); deleteFile('RutaSerM', '<?php echo $persona['Rut']; ?>')"><i class="fa-solid fa-trash"></i></button>
    </div>
<?php } else { ?>
    <div class="contenedor-botones">
