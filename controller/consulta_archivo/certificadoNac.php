...
if (!empty($persona['RutaNac'])) { ?>
    ...
    <div class="contenedor-botones">
        ...
        <button type="button" class="btn btn-danger w-100 boton-eliminar" onclick="event.preventDefault(); deleteFile('RutaNac', '<?php echo $persona['Rut']; ?>')"><i class="fa-solid fa-trash"></i></button>
