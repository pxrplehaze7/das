$(document).ready(function() {
    ...
    function agregarDocumento() {
        ...
        '<label for="idSelectCon' + contadorDocumentos + '"><span style="color: #c40055;">*</span> Tipo de Contrato</label>' +
        '<select class="form-select" name="nameSelectCon[]" id="idSelectCon' + contadorDocumentos + '">' +
        ...
        '</div>' +
        '<div class="col-md-1 col-sm-1" style="display: flex !important;align-self: end;padding-left: 0px;justify-content: end;">' +
        '<button style="width:38px" class="btn btn-danger eliminar-documento" type="button">X</button>' +
        '</div>' +
        '<div class="col-md-6 col-sm-6">' +
