...
<body class="sb-nav-fixed">
                    ...
                    <div class="">
                        <div class="card mb-4">
                            ...
                            <label for="filtrobuscar">Filtrar Búsqueda:</label>
                                ...
                                <hr>
                                <br>
                                <table id="total_honorarios" class="table table-striped table-bordered" style="width:100%" data-search="true">
                                    <thead>
                                        <tr>
    ...
    <script src="./assets/js/filtro_honorario.js"></script>
