        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-md">
                    <form id="EdicionDecretosH" enctype="multipart/form-data" method="POST" autocomplete="off">
                        <input name="nameidtrab" value="<?php echo $de['IDTraH'] ?>" id="idtrabid" hidden>
                        ...
                        <div class="title">
                            ...
                            <div class="container-volver">
                                <a class="button-volver" href="editar_registro_honorario.php?idh=<?php echo $id ?>">
                            ...
                            <div id="document-container">
                                <div class="row ">
                                    ...
                                    <div class="col-md-7">
                                        ...
                                        <input type="text" name="namePersona" id="idPersona" class="form-control" value="<?php echo $de['NombreH'] . ' ' . $de['PaternoH'] . ' ' . $de['MaternoH'] ?>" disabled>
                                        <br>
                                    </div>
                                    <div class="col-md-2">
                                ...
                                <div class="row document">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        ...
                                        <select name="nametipoh" class="form-select" id="tipoHono" required>
                                            <option hidden value="">Selecciona</option>
                                            <option value="Por Jornada" <?php echo ($de['TipodeHono'] == 'Por Jornada') ? 'selected' : ''; ?>>Por Jornada</option>
                                            <option value="Por Horas" <?php echo ($de['TipodeHono'] == 'Por Horas') ? 'selected' : ''; ?>>Por Horas</option>
                                            <option value="Por Llamado" <?php echo ($de['TipodeHono'] == 'Por Llamado') ? 'selected' : ''; ?>>Por Llamado</option>
                                        </select>
                                        <br>
                                    </div>
