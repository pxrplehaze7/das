                ...
                <div class="container-md">
                    <form id="editU" method="POST">
                        ...
                        <div class="seccion">
                            <div class="row ">
                                <div class="col-md">
                                    <label for="idRutInpute"><span style="color: #f36f03;">*</span> Rut</label>
                                    <input type="text" name="nameRut" value="<?php echo $us['RutU'] ?>" id="idRutInpute" class="form-control" maxlength="10" required>
                                    <br>
                                </div>
                                <div class="col-md">
                            ...
                            <div class="row" style="padding-bottom: 17px;">
                                ...
                                <div class="col-md">
                                    <label for="idCorreoe"><span style="color: #c40055;">*</span> Correo Electrónico</label>
                                    <input type="text" name="nameCorreo" value="<?php echo $us['CorreoU'] ?>" id="idCorreoe" class="form-control" required>
                                    <br>
                                </div>
                                <div class="col-md">
