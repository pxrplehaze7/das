...
<head>
    ...
    <title>Registro Decreto Honorario</title>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-md">
                    <form id="RegistroDecretosHonorario" enctype="multipart/form-data" method="POST" autocomplete="off">
                        <input name="idtraname" value="<?php echo $idtraH; ?>" id="idtrabid" hidden>
                            ...
                            <div id="document-container">
                                ...
                                <div class="row ">
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" name="nameRut2" id="idRutInputdec" class="form-control" maxlength="10" value="<?php echo $rut ?>" disabled>
                                        <br>
                                    </div>
                                    <div class="col-md-9">
                                ...
                                <div class="row document">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        ...
                                        <input type="date" name="nameFechaDocumento" class="form-control" id="idFechaDocumento">
                                    </div>
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        ...
                                        <input type="date" name="nameFechaInicio" class="form-control" id="idFechaInicio">
                                        <br>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        ...
                                        <input type="date" name="nameFechaTermino" class="form-control" id="idFechaTermino">
                                        <br>
                                    </div>
